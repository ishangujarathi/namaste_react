...
class About extends React.Component {
  ...
  render() {
    return (
      <div className="container mx-auto my-10 p-6 bg-gray-100 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 duration-300 ease-in-out font-sans">
        <div className="max-w-3xl mx-auto">
          {/* About Header */}
          <div className="mb-6">
            <h1 className="text-4xl font-bold mb-4 text-gray-900 flex items-center justify-center relative">
              <FontAwesomeIcon icon={faInfoCircle} className="mr-2 text-blue-500 text-5xl" />
            ...
            {/* Application Name */}
            <h2 className="text-5xl font-bold mb-6 text-gray-900 bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 bg-clip-text text-transparent animate-pulse">
              BiteStream
            </h2>
          </div>
          ...
          {/* Description */}
          <div className="mb-6">
            <p className="text-lg mb-6 text-gray-700 mx-auto max-w-2xl leading-relaxed">
          ...
          <div>
            ...
            <div className="flex justify-center space-x-6">
              <a href="https://www.instagram.com/ishanxgujarathi/" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faInstagram} className="text-4xl text-pink-500 hover:text-pink-600 transition-transform transform hover:scale-110" />
              </a>
              <a href="https://www.linkedin.com/in/ishan-gujarathi-757982204/" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faLinkedin} className="text-4xl text-blue-700 hover:text-blue-800 transition-transform transform hover:scale-110" />
              </a>
              <a href="https://x.com/ixhaan_10" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faTwitter} className="text-4xl text-blue-500 hover:text-blue-600 transition-transform transform hover:scale-110" />
              </a>
              <a href="https://github.com/ishangujarathi" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faGithub} className="text-4xl text-gray-800 hover:text-gray-900 transition-transform transform hover:scale-110" />
              </a>
            </div>
          </div>
        </div>
